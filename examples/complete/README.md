...
|------|-------------|------|---------|:--------:|
| <a name="input_aws_auth_roles"></a> [aws\_auth\_roles](#input\_aws\_auth\_roles) | List of IAM role ARNs to add to the aws-auth configmap | `any` | <pre>{<br>  "groups": [<br>    "system:masters"<br>  ],<br>  "rolearn": "arn:aws:iam::12345678901:role/examplerole",<br>  "username": "examplerole"<br>}</pre> | no |
| <a name="input_cluster_name"></a> [cluster\_name](#input\_cluster\_name) | Name of the cluster | `string` | `"example-complete-eks"` | no |
| <a name="input_enable_fargate_node_groups"></a> [enable\_fargate\_node\_groups](#input\_enable\_fargate\_node\_groups) | Whether to fargate node groups | `bool` | `true` | no |
