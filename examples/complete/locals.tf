...
locals {
  ...
  eks_public_subnet1 = cidrsubnet(local.cidr_block, 8, 50)
  eks_public_subnet2 = cidrsubnet(local.cidr_block, 8, 55)
  eks_public_subnet3 = cidrsubnet(local.cidr_block, 8, 60)
